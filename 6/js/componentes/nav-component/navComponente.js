...
class navComponente extends HTMLElement {
    ...
    connectedCallback() {
        ...
        this.opcionesMenuPrincipal.forEach(opcion => {
            var _a;
            let menuOpcion = ((_a = this.shadowRoot) === null || _a === void 0 ? void 0 : _a.getElementById('menuPrincipal')) || esNull;
        ...
        const button = ((_a = this.shadowRoot) === null || _a === void 0 ? void 0 : _a.getElementById('btnAcceder')) || esNull;
